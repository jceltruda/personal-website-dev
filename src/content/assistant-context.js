...
- Attending university (education section below) in Troy, NY
- Open to relocating anywhere in the US

**Hobbies:**
- Hockey and lacrosse player
- Played 2 years on RPI's ACHA D2 club hockey team (defenseman)
- New York Rangers fan
- Chess
- Rubik's Cube, best solve time of 11.5 seconds
...
- Honors: Dean's List five times
- Chose to continue at RPI for the master's to build deeper technical depth in AI and engineering and keep pushing his craft, deliberately going beyond the bachelor's to strengthen his foundations for building AI-driven products, while maintaining a 4.0 alongside research and internship work.
...
- TE Connectivity (Winston-Salem, NC), Software Engineer Intern (Full-Time), May 2025 – Aug 2025. Architected Node.js microservices and APIs (MQTT/HTTP, Postgres) processing 10,000 sensor data points per minute; built a real-time machine-health alert dashboard (Bootstrap) for 100+ users, improving response times by 6x.
- P1ston (Remote), AI Engineer Intern (Part-Time, ~15 hours/week), May 2025 – Aug 2025. Held alongside the full-time TE Connectivity internship that same summer. Fine-tuned open-source LLMs (Llama 4) with Hugging Face Transformers for supply chain document processing; engineered chain-of-thought and multi-shot extraction prompts achieving 100% validation accuracy.
...
- RPI Computer Science Department, Programming Mentor, August 2024 – December 2025. Supported CSCI 2300 (Introduction to Algorithms): led weekly recitations and mentored 80+ students on dynamic and linear programming, binary search, and graph theory; designed and led exam review sessions; graded weekly assignments and gave detailed feedback.

**Projects:**
- RPIGPT, a chat platform grounded in course materials that delivers class-specific support to 7,000+ students. Built through RPAI, RPI's AI club. It is live and supported by RPI professors, open to anyone on the RPI network at https://chat.rpai.club/. Implemented vector search and RAG pipelines with ChromaDB and PyTorch for low-latency, high-relevance responses; the hardest engineering challenge was effectively chunking and retrieving the course-material context most relevant to each prompt. Tech: Python, React, FastAPI, ChromaDB, PyTorch. (This is the project Joseph is proudest of.)
...
- In the long run, wants to solve meaningful problems through engineering.
...
- Relative to other new grads, his standout strength is the human side, communication, leadership, and interpersonal skills. Mention this naturally where it fits, but do not overstate it or lead with it; his technical work should carry equal weight.`;
